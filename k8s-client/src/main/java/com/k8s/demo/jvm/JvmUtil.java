...
public class JvmUtil {
	...
	public Map<String, Object> cpu() {
		...
		result.put("cpu系统使用率", new DecimalFormat("#.##%").format(systemMXBean.getSystemCpuLoad()));
		result.put("cpuJVM使用率", new DecimalFormat("#.##%").format(systemMXBean.getProcessCpuLoad()));
		result.put("cpu核心数", systemMXBean.getAvailableProcessors());
		return result;
	}
